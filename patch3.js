...
// 1. Add ScrollTrigger to index.html
...
if (!html.includes('ScrollTrigger.min.js')) {
    ...
    // Bump cache buster
    html = html.replace('main.js?v=1.2', 'main.js?v=1.3');
    fs.writeFileSync('index.html', html);
    console.log('Added ScrollTrigger to index.html');
}

// 2. Modify main.js to use GSAP ScrollTrigger
let js = fs.readFileSync('assets/js/main.js', 'utf8');

const oldRevealCodeRegex = /\/\/ Scroll reveal animation[\s\S]*?revealOnScroll\(\); \/\/ Trigger immediately on load/g;
